...
expName = 'IntentionalBinding_NupurShah'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/nupurshah/Desktop/Psychopy/Intentional Binding/IntentionalBinding_NupurShah_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials_2 = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('IntentionalBinding.xlsx'), 
        seed=None, 
    )
    ...
    for thisTrial_2 in trials_2:
        ...
        trial = data.Routine(
            name='trial',
            components=[polygon, polygon_2, key_resp],
        )
        ...
        response = data.Routine(
            name='response',
            components=[text, textbox, button],
        )
    ...
    # completed 34.0 repeats of 'trials_2'
