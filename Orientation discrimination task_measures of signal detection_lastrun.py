...
expName = 'Orientation discrimination task_measures of signal detection'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/nupurshah/Desktop/Psychopy/Orientation Discrimination/Orientation discrimination task_measures of signal detection_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    grating = visual.GratingStim(
        ...
        ori=1.0, pos=(0, 0), draggable=False, size=(0.2, 0.2), sf=5.0, phase=0.0,
    ...
    for thisTrial in trials:
        ...
        trial = data.Routine(
            name='trial',
            components=[fixation, grating, key_resp],
        )
