...
expName = 'WordPriming_NupurShah'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/nupurshah/Desktop/Psychopy/Word Priming/WordPriming_NupurShah_lastrun.py',
