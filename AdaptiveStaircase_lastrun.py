...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/nupurshah/Desktop/Psychopy/Adaptive Staircase/AdaptiveStaircase_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    grating = visual.GratingStim(
        ...
        ori=1.0, pos=(0, 0), draggable=False, size=(0.3, 0.3), sf=8.0, phase=0.0,
    ...
    for thisStair in stair:
        ...
        while continueRoutine:
            ...
            if hasattr(thisStair, 'status') and thisStair.status == STOPPING:
